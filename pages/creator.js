              ...
              <a className={styles.textBtn}>About us</a>
                ...
                <div className={styles.cont}>
                    <div className={styles.middle}>
                        <div className={styles.Head}><text className={styles.sign}>Sign Up as creator</text></div>
                        <div className={styles.one}><input placeholder="Your name"></input></div>
                        <div className={styles.couple}>
                            <div className={styles.two} ><input placeholder="Your email"></input></div>
                            <div className={styles.three} >
                                <div className={styles.small}>+1 <image></image></div>
                                <input placeholder="Your phone number"></input>
                            </div>
                        </div>
                        <div className={styles.couples}>
                            <div className={styles.four}><input placeholder="Pick social media platform"></input><image></image></div>
                            <div className={styles.five}><input placeholder="Type your username"></input></div>
                            <div className={styles.six}><input placeholder="Social following"></input></div>
                        </div>
                        <div className={styles.lowright}>
                            <div className={styles.handle}><text>+ Add more social handle</text></div>
                            <div className={styles.done}><text>Done</text></div>
                        </div>
                    </div>
                </div>
