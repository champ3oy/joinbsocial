  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        ...
        use, store and share your personal information. It also outlines the
        rights you can exercise regarding your personal information and how you
        can contact us if you have any questions or complaints. <br />
        <br />
        ...
        course or service from us, you agree to be bound by this Privacy Policy.
        <br />
        <br />
        Your privacy is important to B.Social, [www.joinb.social] (“app or
        website”), which is operated by BB.Social Inc (“Company”, “we”, “us”, or
        “our”).
        <br />
        <br />
        ...
        <br />
        <br />
        Please read the entire Privacy Policy before you open or use our app or
        visit our website or perform any Actions (as defined below). By visiting
        the website or performing any Actions (as defined below), you consent to
        ...
        (i) receive any free or purchase any paid programs, products or services
        ...
        media platform, (iv) fill out any forms, (v) access public or private
        membership groups, including those hosted via a third-party platform
        (i.e., Facebook), (vi) sign up to become our affiliate partner, (viii)
        ...
        phone call, or email (collectively, the “Actions”). Examples of data we
        may receive include your first name, last name, telephone number, email
        address, shipping address, billing address, physical address (such as
        your address, state, province, ZIP/postal code and city), date of birth,
        gender, account name, billing information (such as your credit card
        number), financial information, Social Security Number, Tax
        Identification Number, Employer Identification Number, PayPal address,
        social media information, and other information you provide to us
        through survey responses, feedback, reviews and other means of
        communication.
        <br />
        <br />
        <strong>Information Collected Automatically. </strong>We collect some
        data automatically when you visit or use our website or open or respond
        to our emails. For example, we may automatically collect information
        when you open or respond to our emails, make a choice with respect to
        communications we send to you, visit any page that displays our content,
        provide information to our service providers or purchase or return a
        Product.
        <br />
        <br />
        <strong>Information from Third Party Sites.</strong> We collect some
        data when you connect with us, comment on or like our posts or otherwise
        interact with us on any social media platform, or when you access public
        or private membership groups hosted on a third party platform (i.e.,
        Facebook, Snapchat and TikTok). Examples of data we may receive include
        ...
        when you access our app / website. Examples of data we may receive
        ...
        Products and tools and other diagnostic data. Examples of additional
        data we may receive when you access our website through a mobile device
        include the type of mobile device you are using, the unique mobile
        device ID, your mobile operating system, web browser software on mobile,
        unique device identifiers and other diagnostic data.
        <br />
        <br />
        <strong>PURPOSES FOR COLLECTING INFORMATION</strong>
        <br /> We use your information for business and commercial purposes. For
        ...
        private membership group or other account or when purchasing a Product.
        <br />
        <br />
        ...
        <br />
        <br />
        Provide promotional and marketing communications and information if you
        elect to receive it, including email marketing.
        <br />
        <br />
        ...
        <br />
        <br />
        Detect security incidents and protect against, stop, resolve and prevent
        any fraud and fraudulent transactions and any malicious, deceptive or
        illegal activity.
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>Affiliate Partners.</strong> We may share your information with
        affiliate partners to generate traffic or leads or for other business
        purposes.
        <br />
        <br />
        <strong>Analytics Providers.</strong> We may share your information with
        analytics providers.
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>Cloud Service Providers.</strong> We may share your information
        ...
        delivery partners, such as those we use to ship or otherwise deliver any
        Products.
        <br />
        <br />
        <strong>Email Marketing and Advertising Providers.</strong> We may share
        your information with marketing and advertising providers, including
        email marketing and campaign providers, marketing software providers,
        direct mail providers, marketing analytics providers and sales funnel
        ...
        Partners. We may share your information with fraud prevention partners.
        <br />
        <br />
        <strong>Fulfillment Partners.</strong> We may share your information
        with fulfillment partners, such as those we use to fulfill any Products.
        <br />
        <br />
        <strong>Government Agencies.</strong> We may share your information with
        government agencies, courts, regulators and law enforcement in the event
        we are required to comply with applicable laws and regulations or a
        legally binding process, or in response to subpoenas, warrants,
        government inquiries or investigations, and court orders. We may also
        share your information (i) to establish, exercise, protect or enforce
        our legal rights and the legal rights of our agents, employees and
        affiliates, (ii) to defend against a legal claim, (iii) to protect you,
        us or third parties against injury, interference, fraud or harm or (iv)
        to take action related to violations of our policies, including this
        ...
        Processors. We may share your information with payment processors, such
        as those we use to collect and process payment for any Products you
        purchase.
        <br />
        <br />
        ...
        information on a public forum, that information will be available to the
        public and we may elect to share your post, comment or review outside of
        the website.
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>Third Parties.</strong> We may share your information with third
        parties whom we have contractual relationships with, such as auditors,
        consultants, lawyers, and other professionals who rely on the data to
        provide us with professional services.
        <br />
        <br />
        ...
        version and operating system (collectively, the “Browsing Information”).
        We may also use, place, collect and store, or allow our third party
        service providers to use, place, collect and store, cookies, web
        ...
        and provide a range of features, customization and functionality. By
        using the website and not opting out of cookies, you consent to the use
        of Browsing Information, cookies and other tracking technologies as
        described in this Privacy Policy. Note that we have no control over
        ...
        <br /> It is important to us that you understand your choices regarding
        ...
        when you receive new cookies. If your browser has such functionalities,
        information on how you can change your cookie settings can typically be
        found in the help section of the browser toolbar. Please note that if
        you do disable cookies, this may have an impact on or interfere with
        your user experience, including your ability to use or make purchases
        from the website, or receive personalized content.
        <br />
        <br />
        ...
        <br />
        You can request that we delete your personal information at any time by
        contacting us using the contact details provided below, subject to
        certain exceptions. You can also (i) request to see your personal
        information that we have available on you, (ii) withdraw consent for our
        use of your personal information, (iii) review and request we rectify,
        change or modify your personal information, (iv) restrict or limit the
        processing of your personal information, (v) cancel the processing of
        your personal information and (vi) request your personal information and
        transfer it to another controller without any impediments on our part by
        contacting us using the contact details provided below.
        <br />
        <br />
        <strong>Unsubscribing from Email Marketing.</strong>
        <br /> When you sign up to receive emails from us, you agree to receive
        email communications from us, which may include newsletters and
        promotional emails. If you receive any email marketing from us, you can
        opt out at any time by clicking the “unsubscribe” link contained in each
        email. Please note that unsubscribing from email marketing does not
        necessarily unsubscribe you from other emails we may send, such as
        emails about any Products you purchase.
        <br />
        <br />
        <strong>Other Opt-Out Options.</strong>
        <br /> If we send you physical mailings or short message service (SMS)
        messages or contact you via telephone, you can opt-out by contacting us
        using the contact details provided below.
        <br />
        <br />
        <strong>DATA RETENTION</strong>
        <br /> We retain personal information as long as it is needed to conduct
        and operate our business or until you ask us to delete your personal
        information by contacting us using the contact details provided below.
        Please note that we cannot control the data retention policies of third
        parties.
        <br />
        <br />
        <strong>THIRD PARTY LINKS</strong>
        <br /> For your convenience, we provide links to third party websites on
        our website, such as links to third party social media platforms. If you
        click on a link to a third party website, you will be directed to a
        third party website. We cannot and do not control the privacy policies,
        content and practices of the website owners and operators of any of the
        third party websites that we link to. We encourage you to visit their
        ...
        internet or other network can be 100% secure, therefore we cannot and do
        not guarantee that personal information you transmit will remain secure
        from misuse or interception in all circumstances. By consenting to this
        ...
        safeguards in place, the applicable privacy laws in the United States of
        America may be less stringent than those of your state, province or
        country.
        <br />
        <br />
        <strong>
        ...
        to “you” and “your” in this section refer only to those covered by GDPR.
        GDPR, which took effect on May 25, 2018, provides privacy rights for
        those inside the European Economic Area. For the purposes of this
        section, “personal information” refers to any information relating to an
        individual which can be directly or indirectly used to identify such
        individual. Examples include first name and last name, email address,
        identification number, information about location, ethnicity, gender,
        biometric data, web cookies, and religious or political beliefs.
        <br />
        <br />
        <strong>Legal basis for processing information.</strong> We may process
        personal information under the following conditions: (i) we have
        ...
        the subject of the personal information is a child). We are happy to let
        you know which legal basis applies to the processing of your personal
        information. You have certain rights you can exercise under the GDPR,
        including the following. Please note that this summary is merely
        provided for your convenience, but we do not warrant the accuracy or
        exhaustiveness of this summary nor should you rely on this as an
        accurate or exhaustive list of your rights.
        <br />
        <br />
        <strong>Right to Access.</strong> You have the right to learn whether or
        not your personal information is being processed. If it is being
        processed, you have the right to access the personal information, and to
        learn certain information about your personal information, including:
        (i) why it is being processed, (ii) the categories of personal
        information we collected, (iii) the recipients or categories of
        recipients to whom we have or will disclose the personal information to,
        (iv) if possible, the amount of time we will store the personal
        information, or if not possible, the criteria we use to determine such
        period and (v) available information about the sources for personal
        information we collected.
        <br />
        <br />
        <strong>Right to Correction.</strong> You have the right to correct any
        inaccurate personal information about yourself. You also have the right
        to complete any incomplete personal information collected, including
        through providing an additional statement.
        <br />
        <br />
        <strong>Right to Be Forgotten.</strong> You have the right to ask us to
        erase your personal information, which we will do without undue delay
        under certain circumstances. Examples may include: (i) where the
        personal information is no longer necessary for the purposes for which
        it was collected, (ii) where you withdraw consent on the basis of which
        we processed your personal information, and there is no legal ground for
        processing such personal information, (iii) where you invoke your right
        to object (described below) and there are no overriding grounds for
        processing such personal information, (iv) where your personal
        ...
        information under certain circumstances. Examples may include: (i) where
        you indicate the inaccuracy of your personal information, (ii) where the
        processing is unlawful but you would like the processing of your
        personal information to be restricted as opposed to erased, (iii) where
        we no longer need the personal information for processing, but you would
        like it restricted for a legal basis, and (iv) where you invoke your
        right to object (described below).
        <br />
        <br />
        <strong>Notification of Recipients of Personal Information.</strong> If
        you exercise your Right to Rectification, Right to Be Forgotten or Right
        to Restrict Processing (each as described above), we will convey that to
        ...
        a complaint with a supervisory authority. For more information, please
        contact your local data protection authority.
        <br />
        <br />
        <strong>Right to Be Informed About International Transfers.</strong> You
        have the right to be informed about the international transfer of your
        personal information and safeguards in place. Please read the section of
        this Privacy Policy titled “International Data, Transfers and
        Processing”.
        <br />
        <br />
        ...
        subjected to any decisions arising from automated processing, including
        ...
        details provided below. We are required to verify the identity of anyone
        who makes any request.
        <br />
        <br />
        <strong>NOTICE TO CALIFORNIA RESIDENTS (CCPA NOTICE)</strong>
        <br />
        The information in this section, under the subheading “Notice to
        California Residents”, applies to residents of California. References to
        “you” and “your” in this section refer only to residents of California.
        The California Consumer Protection Act (“CCPA”), which took effect on
        January 1, 2020, provides privacy rights for residents of California.
        Please refer to the referenced sections in this Privacy Policy for
        details on the following, which you have a right to know under the CCPA:
        <br />
        <br />
        To review information on the categories of personal information and the
        categories of sources from which we collect, use, store and share
        ...
        the CCPA, including the following. Please note that this summary is
        merely provided for your convenience, but we do not warrant the accuracy
        or exhaustiveness of this summary nor should you rely on this as an
        accurate or exhaustive list of your rights.
        <br />
        <br />
        ...
        over the past 12 month period, including: (i) the categories of personal
        ...
        information, and (vi) if we sold or disclosed your personal information,
        then (a) a list disclosing the categories of personal information
        involved in sales and the categories of third parties to whom we sold
        your personal information and (b) a list disclosing categories of
        personal information disclosed for a business purpose and the categories
        of third parties with whom we shared your personal information. You have
        the right to obtain this information from us, free of charge, twice each
        year.
        <br />
        <br />
        <strong>Right to Delete. </strong>You have the right to request that we
        delete your personal information that we have collected, subject to
        certain exceptions. When you contact us, please let us know the
        information you are requesting we remove, update, correct or amend, and
        the timeframe and manner in which you believe we came to collect such
        information.
        <br />
        <br />
        ...
        <br />
        <br />
        <strong>Right to Non-Discrimination. </strong>You have the right not to
        receive discriminatory treatment by us for exercising your rights under
        the CCPA. We will not discriminate against you in any way for exercising
        any of the rights available to you under the CCPA, including by denying
        you goods or services, charging you different prices or rates, providing
        you with a lesser quality of goods or services or suggesting that you
        would receive a different price or rate for goods or services or a
        ...
        <br />
        <br />
        <strong>CHILDREN’S PRIVACY </strong>This website is not directed towards
        or designed for use by children under the age of 13 unless otherwise
        used under parental guidance. This website and the information contained
        on it is specifically designed for individuals over the age of 13. If
        you are under the age of 13, you must not access this website or perform
        any of the Actions unless guided by your parent. We do not knowingly
        collect, use, store or share personal information from children under
        the age of 13. If you know or have reason to believe that we have
        collected data from anyone under the age of 13, please contact us using
        the contact details provided for removal of that data.
        <br />
        <br />
        ...
        as your continued use of the website and our Products after the Privacy
        Policy is amended will constitute your acceptance and agreement to
        continue to be bound by the Privacy Policy as of the last updated date
        indicated at the top of this page.
        <br />
        <br />
        <strong>ALTERNATIVE FORMS </strong>You may print this Privacy Policy by
        using the “Print” function on your browser.
        <br />
        <br />
        <strong>HOW TO CONTACT US </strong>If you have any questions or
        complaints related to this Privacy Policy, or would like to exercise any
        of your rights, please contact us using the information below.
        <br />
        <br />
        <br />
        ...
        By phone:
        <br />
        By contact form: [insert contact form].
        <br />
        <br />
        <br />
      </main>
